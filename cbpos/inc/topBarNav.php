  ...
  <div class="container px-3 px-lg-5">
    ...
    <div class="d-flex align-items-center w-100 cpms-topbar__row">
      ...
      <a class="nav-link d-lg-none mobile-cart"
        ...
        <span class="badge rounded-pill" id="cart-count-mobile"><?php echo $count; ?></span>
      ...
      <a class="nav-link d-lg-none p-0 cpms-topbar__mobile-cart" href="./?p=cart" aria-label="Cart">
        <i class="bi-cart-fill"></i>
        <span class="badge rounded-pill" id="cart-count-mobile">0</span>
      </a>
    ...
    <div class="d-none d-lg-flex align-items-center cpms-topbar__desktop-actions ml-3">
      ...
      <?php else: ?>
        <a class="mr-3 nav-link" href="./?p=cart" aria-label="Cart">
          <i class="bi-cart-fill mr-1"></i>
          <span class="badge ml-1 rounded-pill" id="cart-count">0</span>
        </a>
        <button class="btn btn-sm cpms-topbar__login-btn" id="login-btn-desktop" type="button">| Log In |</button>
      <?php endif; ?>
    <!-- DESKTOP ACTIONS -->
...
$(function () {
    ...
    $('#login-btn, #login-btn-desktop').on('click', function () {
        uni_modal("", "login.php");
    });
